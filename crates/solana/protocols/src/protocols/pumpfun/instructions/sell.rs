...
use super::super::constants::{
    BONDING_CURVE_SEED, BONDING_CURVE_V2_SEED, EVENT_AUTHORITY_PDA, FEE_COLLECTOR, FEE_CONFIG_PDA,
    GLOBAL_PDA, PROGRAM_ID, PUMP_FEES_PROGRAM_ID, SELL_DISCRIMINATOR, USER_VOLUME_ACCUMULATOR_SEED,
};
...
/// See [`BuyAccounts`](super::buy::BuyAccounts) on the SOL quote side.
