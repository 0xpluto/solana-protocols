...
impl CollectCreatorFeeV2Params {
...
impl crate::parsing::FromInstructionData for CollectCreatorFeeV2Params {
    fn from_instruction_data(data: &[u8]) -> Result<Self, crate::parsing::InstructionParseError> {
        ...
        Err(
            crate::parsing::InstructionParseError::DeserializationFailed(format!(
                "CollectCreatorFeeV2Params takes no arguments, got {} bytes",
                data.len()
            )),
        )
    }
