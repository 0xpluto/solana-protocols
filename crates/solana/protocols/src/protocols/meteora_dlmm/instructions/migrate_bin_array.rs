...
//!
//! - **Parse:** [`MigrateBinArrayIx::parse`] decodes from a
//!   [`ParsedInstruction`] into typed accounts + args (when present).
//! - **Build:** [`MigrateBinArrayIx::build`] returns a ready-to-submit
...
pub use meteora_dlmm_sdk::instructions::MIGRATE_BIN_ARRAY_DISCRIMINATOR;
